...
/**
 * copy_info - copy the information to create a new env or alias
...
/**
 * set_env - set a environment variable
 *
...
/**
 * _setenv - compares environment variables names with the name that is passed.
